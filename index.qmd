...
Samlingen inneholder **758 lover** og
**5 130 sentrale forskrifter**,
...
- [`amendments.jsonl.gz`](amendments.jsonl.gz) — 99 848 rader, én per (lov, paragraf, endring). Inkluderer `new_text`
- [`amendment-acts.jsonl.gz`](amendment-acts.jsonl.gz) — 39 130 rader, én per endringslov
- [`laws.json`](laws.json) — alle 5 888 lover/forskrifter med metadata og endringstellere
...
- [Stabile versjoner](book/versjoner.qmd) — sammenlign lover mellom årsversjoner (v2000–v2028)
