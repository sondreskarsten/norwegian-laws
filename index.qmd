...
- [`amendments.jsonl.gz`](amendments.jsonl.gz) — 99 110 visningsrader med identifisert mållov eller -forskrift. `new_text` er avkortet til 4 000 tegn
- [`amendment-acts.jsonl.gz`](amendment-acts.jsonl.gz) — 39 214 kunngjøringer med publiseringsdato fra Norsk Lovtidend, inkludert endringslover og forskrifter
