...
- [`amendments.jsonl.gz`](amendments.jsonl.gz) — 99 884 rader, én per (lov, paragraf, endring). Inkluderer `new_text`
- [`amendment-acts.jsonl.gz`](amendment-acts.jsonl.gz) — 39 157 rader, én per endringslov
- [`laws.json`](laws.json) — alle 5 869 lover/forskrifter med metadata og endringstellere
