...
- [`amendments.jsonl.gz`](amendments.jsonl.gz) — 99 912 rader, én per (lov, paragraf, endring). Inkluderer `new_text`
- [`amendment-acts.jsonl.gz`](amendment-acts.jsonl.gz) — 39 179 rader, én per endringslov
