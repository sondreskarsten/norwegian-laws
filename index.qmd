...
- [`amendments.jsonl.gz`](amendments.jsonl.gz) — 99 895 rader, én per (lov, paragraf, endring). Inkluderer `new_text`
- [`amendment-acts.jsonl.gz`](amendment-acts.jsonl.gz) — 39 170 rader, én per endringslov
