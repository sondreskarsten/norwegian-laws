...
Samlingen inneholder **762 lover** og
**5 152 sentrale forskrifter**,
...
- [`amendments.jsonl.gz`](amendments.jsonl.gz) — 99 769 rader, én per (lov, paragraf, endring). Inkluderer `new_text`
- [`amendment-acts.jsonl.gz`](amendment-acts.jsonl.gz) — 39 075 rader, én per endringslov
- [`laws.json`](laws.json) — alle 5 914 lover/forskrifter med metadata og endringstellere
