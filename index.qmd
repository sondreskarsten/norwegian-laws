...
- [`amendments.jsonl.gz`](amendments.jsonl.gz) — 99 776 rader, én per (lov, paragraf, endring). Inkluderer `new_text`
- [`amendment-acts.jsonl.gz`](amendment-acts.jsonl.gz) — 39 084 rader, én per endringslov
