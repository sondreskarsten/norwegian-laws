...
d. har mottatt midler fra Kulturdepartementets andre støtteordninger som følge av covid-19, for samme arrangement som det søkes om tilskudd til under denne ordningen, eller
e. har eller kan få bidrag til å gjennomføre arrangementet fra forsikring, avtale e.l.
...
a. 50 % av distributørens støtteberettigede kostnader av en film
b. 60 % av distributørens støtteberettigede kostnader av en film produsert på tvers av landegrensene, som støttes av flere enn én EU/EØS medlemsstat og omfatter produsenter fra flere enn én EU/EØS medlemsstat eller
c. 100 % av distributørens støtteberettigede kostnader for smale filmer.
