...
sist-endret: "forskrift/2020-12-04-2614"
...
1. slåttemark, inkludert lauveng og semi-naturlig våteng med slåttemarkspreg, klassifisert av Miljødirektoratet som
  a. «svært viktig» (A-lokalitet) eller «viktig» (B-lokalitet), for lauveng omfattes også forekomster klassifisert som «lokalt viktig» (C-lokalitet), eller
  b. «svært høy», «høy» eller «moderat lokalitetskvalitet», eller «lav lokalitetskvalitet» med enten «moderat tilstand» eller «moderat naturmangfold», for lauveng omfattes også forekomster klassifisert som «lav» eller «svært lav lokalitetskvalitet».
...
2. slåttemyr klassifisert av Miljødirektoratet som
  a. «svært viktig» (A-lokalitet) eller «viktig» (B-lokalitet), eller
  b. «svært høy», «høy» eller «moderat lokalitetskvalitet», eller «lav lokalitetskvalitet» med «moderat tilstand».
...
6. kystlynghei klassifisert av Miljødirektoratet som
  a. «svært viktig» (A-lokalitet) eller «viktig» (B-lokalitet), eller
  b. «svært høy», «høy», «moderat» eller «lav lokalitetskvalitet».
...
9. Korallrev. Med korallrev menes et havbunnsområde med revbyggende koralldyr i kolonier bestående av både levende og døde deler, som dekker minst 25 m 2 . Korallrevet kan bestå av flere enkeltstående korallkolonier som sammen dekker minst 75 % av minsteområdet.
