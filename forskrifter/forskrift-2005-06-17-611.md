...
4. rutiner virksomheten følger for å sikre overholdelse av kravene, herunder rutiner for:
  4.1 oppfyllelse av krav om at avidentifiserende opplysninger bare behandles når dette er nødvendig for å fremme formålet med behandlingen av opplysningene, og i tråd med gjeldende bestemmelser om taushetsplikt, jf. helseregisterloven § 6 og § 17 ,
  4.2 dokumentasjon og kvalitetskontroll av helseopplysningene, jf. forskriften § 1-8 ,
  4.3 hvordan virksomheten oppfyller bestemmelsene om tilgjengeliggjøring av opplysninger fra helseregistre, jf. forskriften § 3-1 ,
