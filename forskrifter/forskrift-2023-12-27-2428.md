...
a. Fullført og bestått videregående opplæring med generell studiekompetanse, fagbrev, svennebrev eller vitnemål fra relevant yrkesutdanning. Informasjon om hvilke kompetanser som gir rett til opptak på den enkelte utdanning finnes i de enkelte studieplaner.
...
c. Bestå opptaksprøve.
d. Studenter må være fylt 18 år for å gjennomføre Skilltest (Ferdighetsprøve). Dette iht. internasjonal lov om luftfart (Part FCL).
e. Søkeren må inneha gyldig medisinsk sertifikat for flygere klasse 1 før første soloflyging kan gjennomføres.
...
a. Opptaksprøven er utviklet for seleksjon av pilotkandidater. Kandidaten blir testet på områder som:
...
a. Når alle emnene av utdanningen er fullført vil studenten få utstedt trafikkflygersertifikat (CPL) fra luftfartsmyndigheten (CAA-N).
b. Studenter som avbryter utdanningen underveis, kan ved anmodning få utstedt en karakterutskrift for de deler av utdanningen som er bestått. De oppnår også studiepoeng for de emnene som er bestått.
...
c. Emner
d. Kvalifikasjonsnivået som oppnås
e. Karaktersystemet som benyttes (5–1 eller bestått/ikke bestått)
